...
namespace LeaveManagement.Repository
{
    public class AccountRepository : IAccountRepository
    {
        ...
        private readonly ILeaveAllocationRepository _leaveAllocationRepository = null;
        ...
        public async Task<IdentityResult> CreateUserAsync(SignupUserModel userModel)
        {
            ...
            if (result.Succeeded)
            {
                ...
                {
                    //Add role Employee to user by default
                    await _userManager.AddToRoleAsync(user, Enums.RolesEnum.Employee.ToString());
                }

                await GenerateEmailConfirmationTokenAsync(user);
                await _leaveAllocationRepository.SetLeave(user.Id);
            }
